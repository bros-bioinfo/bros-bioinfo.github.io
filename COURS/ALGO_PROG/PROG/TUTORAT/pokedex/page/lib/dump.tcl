...
# When we want to save this stuff then we want $target below.
# When we want to copy we want \$target below.  Rozen 2/25/16
            if {$vTcl(copy)} {
...
proc vTcl:dump:widgets {target} {
    ...
    set dontDumpChildren {Frame MegaWidget Menu Menubutton Labelframe
        TLabelframe TFrame Scrolledtreeview Custom} ;# Rozen added these.
