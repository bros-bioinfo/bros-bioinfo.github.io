    ...
    print(
        """
         -._    _.--'"`'--._    _.--'"`'--._    _.--'"`'--._    _
           ...
           """)
    name = input("  Quel est le nom de votre PNJ ? ")
    name = name.upper()
    IAtype = input("  Quel est le type de votre PNJ ? ")
    IAtype = IAtype.upper()
    PV = int(input("  Combien votre PNJ a de PV ? "))
    Level = int(input("  Quel est le level de votre PNJ ? "))
    Attaque1 = input("  Entrez le nom de la premiere attaque:  ")
    Attaque1 = Attaque1.upper()
    Attaque2 = input("  Entrez le nom de la premiere attaque:  ")
    Attaque2 = Attaque2.upper()
    Attaque3 = input("  Entrez le nom de la premiere attaque:  ")
    Attaque3 = Attaque3.upper()
    Attaque4 = input("  Entrez le nom de la premiere attaque:  ")
...
def fight(pokedex, player):
    ...
    print("\n\n")
    print("       " + str(pvbarre) + "/50" + "   " + '█' * pvbarre + '░' * pvbarremanquant + " : HP |      " +
          listeIA[IA][0])
    versus()
    print("\n                                                 " + pokedex[k][
        0] + "      | HP: " + '█' * pvbarrejoueur + '░' * pvbarremanquantjoueur + "   " + str(pvbarrejoueur) + "/50")
    pause()
    ...
    while (PV > 0 and PV2 > 0):
        ...
        # choice=int(choice)
        choice = index + 1
        while (CP1 == 0 and choice + 3 == 4) or (CP2 == 0 and choice + 3 == 5) or (CP3 == 0 and choice + 3 == 6) or (
                CP4 == 0 and choice + 3 == 7):
            print
            "     Il vous faut choisir une autre attaque, vous n'avez plus assez de CP !!\n"
            time.sleep(2)
            os.system('clear')
            atk = "\nQuelle attaque voulez-vous utiliser ?\n"
            attaque1 = "CP: " + str(CP1) + "/2     | " + pokedex[k][4]
        ...
        versus()
        print("\n                                                 " + pokedex[k][
            0] + "      | HP: " + '█' * pvbarrejoueur + '░' * pvbarremanquantjoueur + "   " + str(
            pvbarrejoueur) + "/50")
        # FIN HP + PERSO ANIMATION
