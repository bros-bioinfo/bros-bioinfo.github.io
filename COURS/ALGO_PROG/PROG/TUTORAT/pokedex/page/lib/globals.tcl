...
#set vTcl(pr,proportional_geometry) 0    ;# Rozen
set vTcl(pr,default_origin) 0    ;# Rozen
...
set vTcl(tk_default_treehighlight) #0000ff   ;# blue
...
#set vTcl(geometry,.vTcl.gui_console) +500+100
